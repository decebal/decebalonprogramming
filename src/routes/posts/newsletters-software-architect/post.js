export default {
  ...
  spoiler: "Staying up to date with technology developments is an important part of a modern software \n" +
    "developer's daily activity as well as one of the defining behaviours for a successful\n" +
    "career. This is my list of newsletters that I am grateful for.",
